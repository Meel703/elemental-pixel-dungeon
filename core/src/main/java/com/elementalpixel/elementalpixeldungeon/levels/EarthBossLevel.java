...
public class EarthBossLevel extends Level {
	...
	public static class CustomGroundVisuals extends CustomTilemap {
		...
		public String name(int tileX, int tileY) {
			...
			if (cell < Dungeon.level.width*22){
				...
				if (Dungeon.level.map[cell] == Terrain.SIGN){
					return Messages.get(EarthBossLevel.class, "throne_name");
				} else if (Dungeon.level.map[cell] == Terrain.PEDESTAL){
					return Messages.get(EarthBossLevel.class, "summoning_name");
				}
			}
		...
		public String desc(int tileX, int tileY) {
			...
			//DK arena tiles
				...
				if (Dungeon.level.map[cell] == Terrain.SIGN){
					return Messages.get(EarthBossLevel.class, "throne_desc");
				} else if (Dungeon.level.map[cell] == Terrain.PEDESTAL){
					return Messages.get(EarthBossLevel.class, "summoning_desc");
				}
			}
