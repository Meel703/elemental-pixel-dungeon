...
public class InfernalFire extends Blob {
	...
	public static void burn( int pos ) {
		...
		if (ch != null && !ch.isImmune(InfernalFire.class)) {
			Buff.affect( ch, InfernalFlame.class ).reignite( ch );
		}
	...
	public void use( BlobEmitter emitter ) {
		super.use( emitter );
		emitter.pour( InfernalFlameParticle.FACTORY, 0.03f );
	}
