...
public class GreatFireDemonSprite extends MobSprite {

    protected static MagicMissile m = new MagicMissile();;

    public GreatFireDemonSprite() {
        super();
    ...
    public void zap( int cell ) {
        ...
        m.boltFromChar( parent, MagicMissile.FIRE_CONE,this, cell,
                new Callback() {
                    @Override
                    public void call() {
                        ((GreatFireDemon)ch).onZapComplete();
                    }
                } );
        Sample.INSTANCE.play( Assets.Sounds.ZAP );
    }

    public void throwInfernalFire( int cell ) {

        turnTo( ch.pos, cell );
        play( throwInfernalFire );

        MagicMissile.boltFromChar( parent, MagicMissile.FIRE, this, cell,
                new Callback() {
                    @Override
                    public void call() {
                        ((GreatFireDemon)ch).onThrowComplete();
                    }
                } );
    }
    ...
    public void onComplete( Animation anim ) {
        if (anim == zap || anim == throwInfernalFire) {
            idle();
        }
