...
package com.elementalpixel.elementalpixeldungeon.android;
...
public class AndroidGame extends AndroidApplication {
	...
	private static com.elementalpixel.elementalpixeldungeon.android.AndroidPlatformSupport support;
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			SPDSettings.set(instance.getPreferences("ElementalPixelDungeon"));
		...
		if (support == null) support = new com.elementalpixel.elementalpixeldungeon.android.AndroidPlatformSupport();
